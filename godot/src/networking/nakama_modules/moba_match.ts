...
// ── RPC find_moba_match ──────────────────────────────────────────────────────
const rpcFindMobaMatch: nkruntime.RpcFunction = function (ctx, logger, nk, payload) {
...
const matchInit: nkruntime.MatchInitFunction<MobaState> = function (_ctx, logger, _nk, _params) {
...
const matchJoinAttempt: nkruntime.MatchJoinAttemptFunction<MobaState> = function (_ctx, _logger, _nk, _d, _t, state, _p, _m) {
...
const matchJoin: nkruntime.MatchJoinFunction<MobaState> = function (_ctx, logger, _nk, dispatcher, _tick, state, presences) {
...
const matchLeave: nkruntime.MatchLeaveFunction<MobaState> = function (_ctx, logger, _nk, dispatcher, _tick, state, presences) {
  for (const presence of presences) {
...
const matchLoop: nkruntime.MatchLoopFunction<MobaState> = function (_ctx, logger, _nk, dispatcher, tick, state, messages) {
  state.tick = tick;
...
const matchTerminate: nkruntime.MatchTerminateFunction<MobaState> = function (_ctx, logger, _nk, _d, _t, state, _grace) {
