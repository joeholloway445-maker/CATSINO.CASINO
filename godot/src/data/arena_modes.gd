...
const MODES: Array[Dictionary] = [
	...
	{id="moba", name="Paws of the Ancients", desc="3-lane push: minion waves, tower AI, nexus win, and an in-match item shop (B).", team_size=5, uses_entities=true, scene="res://scenes/world/playtest_arena.tscn"},
