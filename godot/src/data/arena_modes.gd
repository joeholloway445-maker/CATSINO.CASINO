...
const MODES: Array[Dictionary] = [
	...
	{id="moba", name="Paws of the Ancients", desc="Full lane MOBA: towers/inhibs/nexus, wave types, bots, companion, fountain shop (B), recall (R), XP/CS/KDA.", team_size=5, uses_entities=true, scene="res://scenes/world/playtest_arena.tscn"},
