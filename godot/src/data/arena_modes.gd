...
const MODES: Array[Dictionary] = [
	{id="duel", name="1v1 Duel", desc="Head-to-head trial arena. Prove yourself alone.", team_size=1, uses_entities=true, scene="res://scenes/ascension/trial_arena.tscn"},
	...
	{id="moba", name="Paws of the Ancients", desc="5v5 lane-push MOBA with entity companions as summons.", team_size=5, uses_entities=true, scene="res://scenes/ui/tournament.tscn"},
	...
	{id="ctf", name="Yarn Rush", desc="Capture the yarn ball. Fast respawns, faster grudges.", team_size=6, uses_entities=false, scene="res://scenes/world/combat_zone.tscn"},
