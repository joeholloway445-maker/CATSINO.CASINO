...
All files below are **CC0** from [Kenney.nl](https://kenney.nl).

| Slot / file | Pack |
|---|---|
| `card_shuffle`, `card_place`, `chip_*`, `dice_throw`, `door_slide`, `casino/*` | [Casino Audio](https://kenney.nl/assets/casino-audio) |
