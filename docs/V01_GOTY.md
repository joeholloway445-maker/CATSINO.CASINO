...
| 8 | Real multiplayer beyond presence bots | **Hideout online Done** — `hideout_claim` / `hideout_contest_win` + HideoutRegistry sync; `gate8_smoke` auth/wallet/story_vote/hideout. Layer presence on PR #60. **Prod host/secrets owner-only** |
