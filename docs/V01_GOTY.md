...
| 8 | Real multiplayer beyond presence bots | Client + docker-compose + `layer_presence` + world-boss cadence + board_id alias + live CI `gate8_smoke`; **prod host/secrets owner-only** |
