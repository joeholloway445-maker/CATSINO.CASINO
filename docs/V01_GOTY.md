...
| 8 | Real multiplayer beyond presence bots | **Hideout online Done** — `hideout_claim` / `hideout_contest_win` + HideoutRegistry sync + board_id alias; `gate8_smoke`. Layer presence on PR #60. **Prod host/secrets owner-only** |
