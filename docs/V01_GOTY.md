...
| 8 | Real multiplayer beyond presence bots | **Hideout online Done** — `hideout_claim` / `hideout_contest_win` + layer presence + board_id alias; `gate8_smoke`. **Prod host/secrets owner-only** |
