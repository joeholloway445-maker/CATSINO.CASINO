  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-center text-gray-400 mb-8">Spend Cat Coins to discover new companions</p>
        ...
        <div className="bg-gray-800 rounded-2xl p-6 mb-8">
          ...
          <div className="flex gap-4 justify-center">
            ...
            >
              Summon × 1
              <span className="block text-xs text-purple-200">300 coins</span>
            </button>
            <button
              onClick={() => summon(10)}
              disabled={loading}
            ...
            >
              Summon × 10
              <span className="block text-xs text-yellow-900">2,500 coins</span>
            </button>
          </div>
